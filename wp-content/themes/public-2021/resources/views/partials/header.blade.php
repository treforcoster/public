      ...
      <a href="<?= esc_url(home_url('/')); ?>">
        ...
        <style type="text/css">
          ...
          <g>
            ...
            v25.5H17.6V0z"/>
            <path class="logo-fill letter letter-u" d="M71.2,19.7h11v24.4c0,3.3,0.1,6.5,1.2,8.9c1.1,2.4,3.2,4,7,4c6.8,0,9.8-5.3,9.8-12.7V19.7h11v45.9h-11v-5.9
            c-2.2,3.9-7.1,7-13.7,7c-4.6,0-8.6-1.4-11.3-4.4c-2.9-3.3-4-6.5-4-16.6V19.7z"/>
            <path class="logo-fill letter letter-b" d="M140.1,57.2c7,0,11.7-5.5,11.7-14.6c0-9.3-4.6-14.7-11.7-14.7c-6.9,0-11.7,5.8-11.7,14.7
            ...
            <rect x="167" y="1.4" class="logo-fill letter letter-l" width="11" height="64.2"/>
            <path class="logo-fill letter letter-i" d="M195.7,65.5h-11V19.7h11V65.5z M195.7,12.6h-11V1.4h11V12.6z"/>
            <path class="logo-fill letter letter-c" d="M235.1,36.3c-1.6-4.9-5.1-8.3-10.7-8.3c-7.3,0-12,5.4-12,14.6s4.7,14.6,12,14.6c6.3,0,9.4-3.7,11-7.8l8.9,4.7
